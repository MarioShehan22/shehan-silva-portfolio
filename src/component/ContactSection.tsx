            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                        I’m a Computer Science graduate open to internships, junior roles, and collaborative projects.
                    </p>
                </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="glass p-8 rounded-3xl">
                            ...
                            <p className="text-green-400">
                                Available for learning, internships, and entry-level opportunities
                            </p>
                        </div>
                        ...
                        <div className="glass p-8 rounded-3xl">
                            ...
                            <div className="flex items-center gap-4">
                                <a
                                    href="https://www.linkedin.com/in/shehan-mario"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center justify-center w-10 h-10 bg-blue-600 rounded-full hover:bg-blue-500 transition-colors"
                                >
                                ...
                                <a
                                    href="https://github.com/MarioShehan22"
                                    target="_blank"
                                    rel="noopener noreferrer"
