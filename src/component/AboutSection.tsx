            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                        Computer Science undergraduate with hands-on experience in backend and
                        full-stack development using Java, Spring Boot, and RESTful APIs.
                        Focused on building secure, scalable applications with modern architecture,
                        authentication systems, and production-ready deployment workflows.
                    </p>
                </div>
                    ...
                    <div className="space-y-6">
                        <div className="glass p-8 rounded-3xl">
                            ...
                            <p className="text-gray-300">
                                Pursuing BSc. (Hons) in Computer Science with strong foundations in
                                data structures, object-oriented programming, and scalable backend architecture.
                                Experienced in building real-world systems across the full software development lifecycle.
                            </p>
                        </div>
                        ...
                        <div className="glass p-8 rounded-3xl">
                            ...
                            <p className="text-gray-300">
                                Collaborative team member and Web Master for IEEE CS Chapter and Gavel Club,
                                developing and maintaining production-level web platforms while working in
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="glass p-8 rounded-3xl hover:scale-105 transition-transform">
                        ...
                        <p className="text-gray-300">
                            Building complete web applications using React, Spring Boot, and Node.js,
                            with strong integration between frontend, backend, and databases.
                        </p>
                    </div>
                    ...
                    <div className="glass p-8 rounded-3xl hover:scale-105 transition-transform">
                        ...
                        <p className="text-gray-300">
                            Designing RESTful APIs, implementing business logic, and managing data flow
                            using Spring Boot, Node.js, and database systems.
                        </p>
                    </div>
                    ...
                    <div className="glass p-8 rounded-3xl hover:scale-105 transition-transform">
                        ...
                        <h3 className="text-xl font-bold mb-3">Authentication & Security</h3>
                        <p className="text-gray-300">
                            Implementing secure authentication using Keycloak, JWT, OAuth2/OIDC,
                            and role-based access control across full-stack applications.
                        </p>
                    </div>
                    ...
                    <div className="glass p-8 rounded-3xl hover:scale-105 transition-transform">
                        ...
                        <h3 className="text-xl font-bold mb-3">DevOps & Containerization</h3>
                        <p className="text-gray-300">
                            Containerizing applications using Docker and Docker Compose,
                            and managing deployment-ready environments for scalable systems.
                        </p>
                    </div>
                    ...
                    <div className="glass p-8 rounded-3xl hover:scale-105 transition-transform">
                        ...
                        <p className="text-gray-300">
                            Designing scalable architectures including monolithic and microservices systems,
                            with proper layering, modularity, and maintainability.
                        </p>
                    </div>
                    ...
                    <div className="glass p-8 rounded-3xl hover:scale-105 transition-transform">
                        ...
                        <h3 className="text-xl font-bold mb-3">API & Database Systems</h3>
                        <p className="text-gray-300">
                            Designing relational and NoSQL databases, optimizing queries,
                            and building efficient data-driven backend services.
                        </p>
                    </div>
                </div>
            </div>
